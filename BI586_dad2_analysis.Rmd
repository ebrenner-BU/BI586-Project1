...
For their analysis, Speare et. al. amplified a 444 bp section of the V3-V4 variable regions of the 16S gene.  The 16S gene... 

In brief summary, the team found that BCC varried significantly between species, and from site-to-site.  However, their findings explained >11% of variability, and future investigation into the factors determining BCC and algal composition are necessary.  

For this assignment, we looked at subsample of 10 of *Siderastrea siderea*, 5 from inshore locations and 5 from offshore locations, and accessed the genomic data from the [NCBI Sequence Read Archive (SRA)](https://www.ncbi.nlm.nih.gov/sra).    
